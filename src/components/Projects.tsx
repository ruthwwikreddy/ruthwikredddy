        ...
        <div className="mt-6 w-full overflow-hidden">
          <div className="futuristic-card overflow-hidden transition-all duration-500 animate-fade-in">
            <div className="p-4 md:p-8 relative">
              ...
              <div className="absolute particle w-2 h-2 opacity-40 bottom-32 right-20 pointer-events-none" style={{"--x1": "-50px", "--y1": "30px", "--x2": "20px", "--y2": "-40px"} as React.CSSProperties}></div>
              <div className="absolute particle w-2 h-2 opacity-40 top-40 left-1/3 pointer-events-none" style={{"--x1": "70px", "--y1": "-20px", "--x2": "-30px", "--y2": "50px"} as React.CSSProperties}></div>
              <div className="absolute particle w-2 h-2 opacity-40 top-20 right-1/4 pointer-events-none" style={{"--x1": "-30px", "--y1": "50px", "--x2": "40px", "--y2": "20px"} as React.CSSProperties}></div>
              <div className="absolute particle w-3 h-3 opacity-30 bottom-40 left-20 pointer-events-none" style={{"--x1": "60px", "--y1": "-40px", "--x2": "-20px", "--y2": "30px"} as React.CSSProperties}></div>
              <div className="absolute particle w-3 h-3 opacity-30 top-60 right-40 pointer-events-none" style={{"--x1": "-20px", "--y1": "60px", "--x2": "50px", "--y2": "-20px"} as React.CSSProperties}></div>
            </div>
          </div>
        </div>
      </div>
