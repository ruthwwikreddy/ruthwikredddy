...
const Featured = () => {
  ...
  const featuredLinks: FeaturedLink[] = [
    ...
    { url: "https://unstop.com/certificate-preview/b1a0bceb-806a-42ff-bf12-601347f504e7?utm_campaign=", title: "Participated in the InnoVision 2024: Igniting Ideas, Shaping the Future", category: "Innovation" },
    { url: "http://unstop.com/certificate-preview/24341243-70d2-4c7a-be8a-bbb5ff82fd2d", title: "Participated in the Youth Entrepreneurship Challenge", category: "Entrepreneurship" },
    { url: "https://unstop.com/certificate-preview/17785b0d-2049-440d-8491-fb660f9ff070", title: "Participated in the TATA Crucible Campus Quiz 2024", category: "Competition" },
  ...
  return (
    <section id="featured" className="py-16 md:py-20 bg-black text-white relative overflow-hidden w-full max-w-[100vw]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-10 left-10 w-32 h-32 rounded-full bg-[#ea384c]/5 blur-3xl"></div>
        <div className="absolute bottom-20 right-20 w-40 h-40 rounded-full bg-[#ea384c]/5 blur-3xl"></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-24 rounded-full bg-[#ea384c]/5 blur-2xl"></div>
      </div>
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="flex flex-col items-center mb-12">
            <div className="flex items-center mb-4">
              <Star className="text-[#ea384c] w-5 h-5 mr-2" />
              <h2 className="text-4xl font-bold text-white uppercase tracking-widest">Featured</h2>
              <Star className="text-[#ea384c] w-5 h-5 ml-2" />
            </div>
            <div className="h-1 w-24 bg-gradient-to-r from-transparent via-[#ea384c] to-transparent rounded-full shadow-[0_0_10px_rgba(234,56,76,0.7)]"></div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10">
            <button 
              ...
              className={`px-3 py-1.5 rounded-full text-sm transition-all duration-300 ${
                activeCategory === null
                  ? 'bg-[#ea384c] text-white shadow-[0_0_10px_rgba(234,56,76,0.5)]'
                  : 'bg-black text-gray-400 border border-[#ea384c]/20 hover:border-[#ea384c]/50'
              }`}
            >
              All
            </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredLinks.map((link, index) => (
              ...
              >
                ...
                {link.category && (
                  <span className="inline-block px-2 py-1 text-xs bg-black/60 text-[#ea384c] rounded-full mb-3 border border-[#ea384c]/20">
                    {link.category}
                  </span>
                )}
